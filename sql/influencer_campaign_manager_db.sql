...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Maj 2025, 20:55
...
(3, 'Anna', 'Kowalska', 'anna.k@gmail.com', '123456789', 'Instagram', 15000, '3.45', 'Moda i lifestyle', NULL),
(4, 'Bartek', 'Nowak', 'bartek.n@gmail.com', '234567891', 'YouTube', 220000, '5.20', 'Gaming', NULL),
(5, 'Celina', 'Wiśniewska', 'celina.w@gmail.com', '345678912', 'TikTok', 80000, '4.80', 'Fitness', NULL),
(6, 'Daniel', 'Malinowski', 'daniel.m@gmail.com', '456789123', 'Twitch', 50000, '2.90', 'Streaming gier', NULL);
...
CREATE TABLE `users` (
  ...
  `email` varchar(150) DEFAULT NULL,
  `role` enum('admin','manager','influencer','viewer') DEFAULT NULL,
...
(1, 'admin1', 'hashedpassword111', 'admin1@gmail.com', 'admin', '2025-05-12 17:42:19'),
(2, 'manager1', 'hashedpassword22', 'manager1@gmail.com', 'manager', '2025-05-12 17:42:19'),
(3, 'viewer1', 'hashedpassword3123', 'viewer1@gmail.com', 'viewer', '2025-05-12 17:42:19'),
(4, 'influencer1', 'hashedpassword55', 'influencer1@gmail.com', 'influencer', '2025-05-12 17:42:19'),
(5, 'influencer2', 'hashedpassword51', 'influencer2@gmail.com', 'influencer', '2025-05-12 17:42:19'),
(6, 'influencer3', 'hashedpassword123', 'influencer3@gmail.com', 'influencer', '2025-05-12 17:42:19'),
(7, 'influencer4', 'hashedpassword5', 'influencer4@gmail.com', 'influencer', '2025-05-12 17:42:19');
